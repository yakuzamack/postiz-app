    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          genericOauth={!!process.env.ALWEAM_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_ALWEAM_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_ALWEAM_OAUTH_DISPLAY_NAME!}
